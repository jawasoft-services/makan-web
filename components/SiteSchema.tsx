  ...
  const graph = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: SITE_URL,
        name: "Makan",
        description: "A food journal for saving what you ate, where you ate it and who was there.",
      ...
      },
      {
        ...
        "@id": `${SITE_URL}/#app`,
        name: "Makan",
        description: "A social food journal with Public and Friends Only sharing.",
