...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-brand-bg px-8 text-center">
      <Image
        src="/makan-icon.svg"
        alt="Makan"
        width={64}
      ...
      <h1 className="mt-4 text-4xl font-bold text-brand-text lg:text-5xl">
        Page not found
      </h1>
      <p className="mt-4 max-w-sm text-lg text-brand-cyan">
