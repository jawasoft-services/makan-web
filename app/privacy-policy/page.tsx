    ...
    <div className="min-h-screen bg-brand-bg">
      <main className="mx-auto max-w-3xl px-5 sm:px-8 pt-24 sm:pt-32 pb-16 sm:pb-24">
        ...
        <div className="mt-10 space-y-10 text-[15px] leading-relaxed text-brand-text/80">
          ...
          <p>
            <strong className="font-semibold text-brand-text">Makan is for deciding what to eat.</strong>{' '}
          ...
          <section>
            ...
            <div className="mt-4 space-y-6">
              <div>
                <h3 className="font-medium text-brand-text">2.1 Account data (App)</h3>
              ...
              <div>
                <h3 className="font-medium text-brand-text">2.2 Meal content and social data (App)</h3>
              ...
              <div>
                <h3 className="font-medium text-brand-text">2.3 Technical, usage, and security data (App and Site)</h3>
                <ul className="mt-2 list-disc pl-5 space-y-1">
              ...
              <div>
                <h3 className="font-medium text-brand-text">2.6 What you have to give us, and what you do not</h3>
                <p className="mt-2">
              ...
              <div>
                <h3 className="font-medium text-brand-text">2.7 How we work out what you like</h3>
                <p className="mt-2">
                ...
                <ul className="mt-2 list-disc pl-5 space-y-1">
                  <li>It is built <strong className="font-semibold text-brand-text">only from choices you made on purpose</strong> — the comparisons you answered. We do not build it by watching what you look at, tap, or linger on.</li>
                  <li>It is <strong className="font-semibold text-brand-text">stored privately against your account and shown only to you.</strong> No other user sees it.</li>
                  <li>It is used <strong className="font-semibold text-brand-text">only to help you decide what to eat.</strong> Never to advertise to you, never to rank you against other people, never to make a decision that affects you outside the App.</li>
                  ...
                  <li>You can <strong className="font-semibold text-brand-text">object</strong> to us building it at all — see section 11 — and it is <strong className="font-semibold text-brand-text">deleted when you delete your account.</strong></li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li><strong className="font-semibold text-brand-text">Help you decide what to eat</strong> — by remembering the meals you have saved, keeping the comparisons you have answered, and building the private picture of your taste described in section 2.7</li>
              ...
              <p>
                <strong className="font-semibold text-brand-text">Dish recognition — a feature we are building.</strong>{' '}
              ...
              <p>
                <strong className="font-semibold text-brand-text">It is not available yet, and nothing analyses your photographs today.</strong>{' '}
              ...
              <p>
                <strong className="font-semibold text-brand-text">If you say no, nothing about the App gets worse.</strong>{' '}
          ...
          <section>
            ...
            <div className="mt-4 space-y-4">
              <p>
                ...
                <strong className="font-semibold text-brand-text">contract</strong> covers your account
                and the core features; <strong className="font-semibold text-brand-text">legitimate
                interests</strong> covers the private taste picture, usage measurement, security,
                fault-fixing, and improving the Services; and{' '}
                <strong className="font-semibold text-brand-text">consent</strong> covers enquiries,
              ...
              <div>
                ...
                <p className="mt-2">
                  <strong className="font-semibold text-brand-text">The private picture of your taste (section 2.7).</strong>{' '}
                ...
                <p className="mt-2">
                  <strong className="font-semibold text-brand-text">Operating and improving the Services.</strong>{' '}
          ...
          <section>
            ...
            <div className="mt-4 space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li><strong className="font-semibold text-brand-text">Public</strong> — visible to other users, and it may appear in discovery features within the App</li>
                <li><strong className="font-semibold text-brand-text">Friends only</strong> — visible to your mutual friends</li>
              </ul>
              ...
              <div className="pt-2">
                <h3 className="font-medium text-brand-text">Featuring your public content in our marketing</h3>
                <p className="mt-2">
          ...
          {/* 6 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">6. Service Providers and Other Recipients</h2>
            <div className="mt-4 space-y-4">
              <p>
              ...
              <div>
                <h3 className="font-medium text-brand-text">Providers that process data on our behalf</h3>
                <ul className="mt-2 list-disc pl-5 space-y-1">
              ...
              <div>
                <h3 className="font-medium text-brand-text">Services your device contacts directly</h3>
                <ul className="mt-2 list-disc pl-5 space-y-1">
          ...
          <section>
            ...
            <div className="mt-4 space-y-3">
              <p>
                <strong className="font-semibold text-brand-text">The Site.</strong> The Site uses
              ...
              <p>
                <strong className="font-semibold text-brand-text">The App.</strong> The App uses
          ...
          {/* 8 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">8. International Data Transfers</h2>
            <div className="mt-4 space-y-3">
              <p>
          ...
          {/* 9 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">9. Security</h2>
            <div className="mt-4 space-y-3">
              <p>
          ...
          {/* 10 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">10. Data Retention</h2>
            <div className="mt-4 space-y-4">
              <p>
              ...
              <div>
                <h3 className="font-medium text-brand-text">10.1 Active accounts</h3>
                <p className="mt-2">
                  Account data and meal content are retained while an account remains active.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-brand-text">10.2 Deleted accounts</h3>
                <p className="mt-2">
              ...
              <div>
                <h3 className="font-medium text-brand-text">10.4 Backups and security logs</h3>
                <ul className="mt-2 list-disc pl-5 space-y-1">
          ...
          {/* 11 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">11. Your Rights</h2>
            <div className="mt-4 space-y-3">
          ...
          <section>
            ...
            <div className="mt-4 space-y-3">
              ...
              <p>
                ...
                <strong className="font-semibold text-brand-text">every</strong> user, not only to
          ...
          {/* 13 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">13. Automated Decision-Making and Profiling</h2>
            <div className="mt-4 space-y-3">
              <p>
          ...
          {/* 14 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">14. Changes to This Policy</h2>
            <div className="mt-4 space-y-3">
