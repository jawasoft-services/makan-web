    ...
    <div className="min-h-screen bg-brand-bg">
      <main className="mx-auto max-w-3xl px-5 sm:px-8 pt-24 sm:pt-32 pb-16 sm:pb-24">
        ...
        <div className="mt-10 space-y-10 text-[15px] leading-relaxed text-brand-text/80">
          ...
          {/* 6 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">6. Service Providers (Processors)</h2>
            <div className="mt-4 space-y-4">
              <p>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <span className="text-brand-text">Google LLC (Firebase)</span> — the App&apos;s
                ...
                <li>
                  <span className="text-brand-text">Vercel Inc.</span> — hosting for the Site, and
          ...
          {/* 13 */}
          <section>
            <h2 className="text-lg font-semibold text-brand-text">13. Automated Decision-Making</h2>
            <p className="mt-4">
